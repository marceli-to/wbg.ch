...
<picture>
  ...
  <img src="/assets/img/preview.png" data-src="{!! ImageHelper::get($teaser->name, 'sm') !!}" alt="{{$teaser->caption}}" title="{{$teaser->caption}}"  height="430" width="280" class="is-responsive lazy">
</picture>
  {{-- <img class="lazyload" src="/assets/img/preview.png" data-src="{!! ImageHelper::get($teaser->name, isset($image_size) ? $image_size : 'lg') !!}" height="430" width="280" alt="{{$teaser->caption}}"> --}}
@endif