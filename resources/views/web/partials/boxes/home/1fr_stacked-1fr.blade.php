      ...
      <div>
        @if (isset($elements[0]))
          <a href="projekt/{{$elements[0]->projectimage->project->id}}">
            <img src="{!! ImageHelper::get($elements[0]->projectimage->name, 'lg') !!}" height="430" width="280" alt="{{$elements[0]->projectimage->caption}}">
          </a>
        @endif
      </div>
    </div>
    ...
    <div>
      @if (isset($elements[2]))
        <a href="projekt/{{$elements[2]->projectimage->project->id}}">
          <img src="{!! ImageHelper::get($elements[2]->projectimage->name, 'lg') !!}" height="560" width="430" alt="{{$elements[2]->projectimage->caption}}">
        </a>
      @endif
    </div>
  </div>
