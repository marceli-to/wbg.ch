  ...
  <div class="legal">
    <div>
      <article class="content-md">
        <h1>Impressum</h1>
        <p>Der Inhalt dieser Website ist urheberrechtlich geschützt. Sämtliche Rechte an den Abbildungen, den darin enthaltenen Darstellungen oder Teilen davon, bleiben vorbehalten. Jegliche Nutzung, insbesondere die Speicherung in Datenbanken, die Vervielfältigung sowie jede Form von gewerblicher Nutzung – auch in Teilen oder in überarbeiteter Form – ist nur mit schriftlicher Zustimmung des Urhebers zulässig.</p>
      </article>
      <article class="content-md privacy">
        ...
        <p>Google Analytics verwendet so genannte &laquo;Cookies&raquo;. Das sind Textdateien, die auf Ihrem Computer gespeichert werden und die eine Analyse der Benutzung der Website durch Sie ermöglichen. Die durch den Cookie erzeugten Informationen über Ihre Benutzung dieser Website werden in der Regel an einen Server von Google in den USA übertragen und dort gespeichert.</p>
        ...
        <p>Diese Website nutzt die Funktion &laquo;demografische Merkmale&raquo; von Google Analytics. Dadurch können Berichte erstellt werden, die Aussagen zu Alter, Geschlecht und Interessen der Seitenbesucher enthalten. Diese Daten stammen aus interessenbezogener Werbung von Google sowie aus Besucherdaten von Drittanbietern. Diese Daten können keiner bestimmten Person zugeordnet werden. Sie können diese Funktion jederzeit über die Anzeigeneinstellungen in Ihrem GoogleKonto deaktivieren oder die Erfassung Ihrer Daten durch Google Analytics wie im Punkt &laquo;Widerspruch gegen Datenerfassung&raquo; dargestellt generell untersagen.</p>
        
        <h2>Google Maps</h2>
        <strong>Umfang, Zweck und Rechtsgrundlage der Datenverarbeitung</strong><br>
        <p>Diese Webseite verwendet Google Maps zur Nutzung von Karten und zur Erstellung von Anfahrtsplänen. Es handelt sich hierbei um einen Dienst der Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043 USA, nachfolgend nur &laquo;Google&raquo; genannt. Durch die Zertifizierung nach dem EU-US-Datenschutzschild (&laquo;EU-US Privacy Shield&raquo;) garantiert Google, dass die Datenschutzvorgaben der EU auch bei der Verarbeitung von Daten in den USA eingehalten werden.</p>
        ...
        <p>Sie haben jederzeit das Recht auf unentgeltliche Auskunft über Ihre gespeicherten personenbezogenen Daten, deren Herkunft und Empfänger und den Zweck der Datenverarbeitung sowie ein Recht auf Berichtigung, Sperrung oder Löschung dieser Daten. Hierzu sowie zu weiteren Fragen zum Thema personenbezogene Daten können Sie sich jederzeit unter der im Impressum angegebenen Adresse an uns wenden oder eine E-Mail an <a href="mailto:mail@wbg.ch" target="_blank">mail@wbg.ch</a> senden.</p>
